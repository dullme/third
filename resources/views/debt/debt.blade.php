    ...
    <div id = "original" style = "left: 200px;position: absolute;top: 100px;">
        ...
        <div style = "padding-left:40px;padding-top:20px;padding-bottom:20px;background-color:#fff;box-shadow: 2px 2px 5px #e5e5e5;padding-right: 30px;">
            <div style = "padding-bottom:30px;">
                ...
                <input class = "input" type = "text" name="name" value="{{ $request->get('name') }}" placeholder="客户姓名"/>
                <input class = "input" style = "margin-left:20px;" type = "text" name="mobile" value="{{ $request->get('mobile') }}" placeholder="手机号"/>
                <input class = "input" style = "margin-left:20px;" type = "text" name="id_card" value="{{ $request->get('id_card') }}" placeholder="身份证号码"/>
                <input class = "input layui-input" style = "margin-left:50px;width: 120px;" id = "date1" name="start" value="{{ $request->get('start') }}" placeholder="放款时间"/>
                <span>至</span>
                <input class = "input layui-input" style = "width: 120px;" id = "date2" name="end" value="{{ $request->get('end') }}" placeholder="放款时间"/>
            ...
            <div>
                @if($request->type ==2)
                <table id = "table1" cellspacing="0" style = "border:1px solid #ccc;width:100%;text-align:center;margin-top:20px;background-color:#fff;">
                    <tr class = "trHeader">
                    ...
                    <tr>
                        ...
                        <td><a href="javaScript:void(0)" style = "text-decoration:none;" onclick="showDetailForPlan({{ $debt->id }})">查看还款计划</a></td>
                    </tr>
                    @endforeach
                </table>
                ...
                @else
                <table id = "table2" cellspacing="0" style = "border:1px solid #ccc;width:100%;text-align:center;margin-top:20px;background-color:#fff;">
                    <tr class = "trHeader">
            ...
            <div id = "plan{{$debt->id}}" style =  "display:none;position: fixed;height:100%;width:100%;top:0;left:0;background-color: rgb(255, 255, 255,0.5);">
                <div id = "showOrHidePlan{{$debt->id}}" style =  "position: fixed;top:100px;left:200px;background-color:#fff; min-height: 100%">
                    <div style = "padding:10px;border-bottom: 1px solid #ccc;">
                        <span >还款计划表</span>
                        <span onclick = "closePlan({{$debt->id}})" style = "float:right;padding-right:20px;">关闭</span>
                    </div>
                    <div>
                        <div style = "display: inline-block;">
                            ...
                            <div class = "divAlert">
                                ...
                                <input class = "inputAlert" value = "{{ getBorrowTypeName()[$debt->borrow_type] }}" disabled = "disabled"/>
                            </div>
                        </div>
                        <div style = "display: inline-block;">
                            <div class = "divAlert">
                                <span class = "divSpanAlert">合同编号:</span>
                                <input class = "inputAlert" value = "{{ $debt->agreement_number }}" disabled = "disabled"/>
                            </div>
                            <div class = "divAlert">
                            ...
                            <div class = "divAlert">
                                ...
                                <input class = "inputAlert" value = "{{ getPayTypeName()[$debt->pay_type] }}" disabled = "disabled"/>
                            </div>
                        </div>
                        <div style = "display: inline-block;">
                            <div class = "divAlert">
                                <span class = "divSpanAlert">借款金额:</span>
                                <input class = "inputAlert" value = "{{ $debt->borrow_money }}" disabled = "disabled"/>
                            </div>
                            <div class = "divAlert">
                        ...
                        <table cellspacing="0" style = "border:1px solid #ccc;text-align:center;margin-left:50px;margin-top:20px;background-color:#fff; width: 90%">
                            <tr class = "trHeader">
            ...
            @else
            @foreach($debts as $debt)
            <div id = "detail{{$debt->id}}" style =  "display:none;position: fixed;height:100%;width:100%;top:0;left:0;background-color: rgb(255, 255, 255,0.5);">
                <div id = "showOrHideDetail{{$debt->id}}" style =  "position: fixed;top:100px;left:200px;background-color:#fff;height: 100%;overflow: scroll">
                        ...
                        <div>
                            ...
                            <div class = "showAll">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <span>工作性质:</span>
                                        <input value = "{{ getNatureWork()[$debt->nature_work] }}" disabled = "disabled"/>
                                    </div>
                                </div>
                                <div>
                                    <div  class = "">
                        ...
                        <div>
                            ...
                            <div class = "showAll">
                                <div>
                                    ...
                                    <div>
                                        <span>还款方式:</span>
                                        <input value = "{{ getPayTypeName()[$debt->pay_type] }}" disabled = "disabled"/>
                                    </div>
                                </div>
                                <div>
                                    <div class = "">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <span>贷款类型:</span>
                                        <input value = "{{ getBorrowTypeName()[$debt->borrow_type] }}" disabled = "disabled"/>
                                    </div>
                                </div>
                                <div>
                                    <div class = "">
                                ...
                                <div>
                                    <div class = "">
                                        <span>进件单标识:</span>
                                        <input value = "@if($debt->is_online == 1) 线上@else 线下 @endif" disabled = "disabled"/>
                                    </div>
                                    <div>
                                        <span>还款能力:</span>
...
@section('script')
    ...
    <script>
        ...
        function showDetail(id){
            ...
            $('#showOrHideDetail'+id)[0].style.width = width + 50 + 'px';
            $('#detail'+id).show();
        }
